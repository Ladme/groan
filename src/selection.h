 ...
 * 
 * \param selection     pointer to a selection to be copies
 * 
...
/* ! \brief Removes atom from atom selection.
 *
 ...
 */ 
size_t selection_remove(atom_selection_t *selection, atom_t *remove);
